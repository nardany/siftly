...
${jobDescription || formRecord.jobDescription || "Ընդհանուր մասնագիտական հմտություններ"}

ՍՏՈՒԳՄԱՆ ՌԵԺԻՄ: ${aiEvaluationMode || formRecord.aiEvaluationMode || "NORMAL"}
...
{"score": 0-100, "summary": "(Մանրամասն, բովանդակալից, խորացված HR վերլուծություն 5-7 նախադասությամբ, ներառյալ CV-ի և պատասխանների գնահատականը)"}`;
